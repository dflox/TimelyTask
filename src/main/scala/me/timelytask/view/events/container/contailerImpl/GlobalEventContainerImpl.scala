...
class GlobalEventContainerImpl(
  ...
  override def shutdownApplication(): Unit = eventHandler.handle(
    new Event[Unit](
      (args: Unit) => {
  ...
  override def newWindow(): Unit = eventHandler.handle(
    new Event[Unit](
      (args: Unit) => {
  ...
  override def newInstance(): Unit = eventHandler.handle(
    new Event[Unit](
      (args: Unit) => {
  ...
  override def addRandomTask(): Unit = eventHandler.handle(
    new Event[Unit](
      (args: Unit) => {
  ...
  override def exportModel(
    ...
    new Event[Unit](
      (args: Unit) => {
        coreModule.controllers.persistenceController
          .saveModel(userToken, folderPath, fileName, serializationType)
        true
      },
      (args: Unit) => None,
      ()
  ...
  override def closeInstance(): Unit = eventHandler.handle(
    new Event[Unit](
      (args: Unit) => {
  ...
  override def importModel(
    ...
    new Event[Unit](
      (args: Unit) => {
        coreModule.controllers.persistenceController
          .loadModel(userToken, folderPathWithFileName, serializationType)
        true
      },
      (args: Unit) => None,
      ()
